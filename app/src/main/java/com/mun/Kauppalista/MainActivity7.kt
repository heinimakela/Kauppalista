...
class MainActivity7 : AppCompatActivity() {
    ...
    private fun fetchList(): ArrayList<Model3> {
        ...
        val kuivat1 = listOf("tacopohja","tortillapohja","taco salsa")
        ...
        val mausteet = listOf("chilijauhe","curry","garam masala","juustokumina","kasvisliemikuutio","korianteri",
            ...
            "valkosipulijauhe","paprikajauhe")
        val pakasteet = listOf("pakastepinaatti","smoothiesekoitus","smoothiehedelmät","puolukka","mustikka","kalapuikko","kasvispihvi")
        ...
        for (aa in aineet){
            when {
                ...
                hygienia.contains(aa) -> aineet2.put(aa,"hygienia")
